...
Taking a page from **Julia & LISP**, allow naming of a "rest" argument
...
_`julia` implements ellipses passing as a special case where rightmost argument is used_
...
cat("  (0, a = 2, ...args)  ==>  (a, b, c, d, e = 4, dots...)")
cat("</pre>")
```
...
- currently syntactically invalid, so no breaking changes!
